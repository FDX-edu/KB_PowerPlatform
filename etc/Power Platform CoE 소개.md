...
| **커넥터 심층 분석** | 전체 앱/흐름에서 사용된 커넥터 종류와 프리미엄 커넥터 사용 현황을 분석하여 보안 및 라이선스 측면에서 대응 방향 설정 |
...
| **YoY 채택** | 앱, 클라우드/데스크톱 흐름, 챗봇, 환경, 제작자 수 등의 연간 증감 추이를 시각화하여 Power Platform의 채택 트렌드 평가 |
| **Power Apps 채택** | 월간 활성 사용자, 신규 사용자, 데이터(Azure, SharePoint, Dataverse) 사용 현황을 통해 Power Apps의 도입 및 확산 상황 분석 |
